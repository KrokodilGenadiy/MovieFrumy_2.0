...
class MainActivityTest {
    ...
    fun recyclerViewShouldBeAttached() {
        ...
        onView(withId(R.id.include)).perform(RecyclerViewActions.actionOnItemAtPosition<FilmViewHolder>(0, click()))
    }
    ...
    fun allMenuDestinationsShouldWork() {
        ...
        onView(withId(R.id.notification_fragment_root)).check(matches(isDisplayed()))

        onView(withId(R.id.ball)).perform(click())
        onView(withId(R.id.ball_fragment_root)).check(matches(isDisplayed()))
